...
from src.diary_ms.application.target_behavior.dto.target_behavior import GetOwnTargetQuery, OwnTargetDTO
...
class GetOwnTarget(QueryHandler[GetOwnTargetQuery, OwnTargetDTO]):
    ...
    async def __call__(self, query: GetOwnTargetQuery) -> OwnTargetDTO:
