...
from src.diary_ms.application.target_behavior.dto.target_behavior import GetOwnTargetDTO, OwnTargetDTO
...
class GetOwnTarget(QueryHandler[GetOwnTargetDTO, OwnTargetDTO]):
    ...
    async def __call__(self, query: GetOwnTargetDTO) -> OwnTargetDTO:
