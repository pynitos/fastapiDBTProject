...
async def on_add_name_entered(_: Message, __: ManagedTextInput, manager: DialogManager, name: str):
    manager.dialog_data["name"] = name
    await manager.next()


async def on_add_dosage_entered(_: Message, __: ManagedTextInput, manager: DialogManager, dosage: str):
