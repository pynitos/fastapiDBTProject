...
from src.diary_ms.domain.model.value_objects.skill import description
...
from src.diary_ms.infrastructure.gateways.sqla.db.tables import (
    diary_card_emotion_assotiation,
    diary_card_medicament_assotiation,
...
def init_mapper():
    mapper_registry.map_imperatively(
        ...
        properties={
            ...
            "emotions": relationship(
                "Emotion", secondary="diary_card_emotion", lazy="selectin"
            ),
            "medicaments": relationship(
                "Medicament", secondary="diary_card_medicament", lazy="selectin"
            ),
            "skills": relationship(
                "Skill",
                secondary="diary_card_skill",
                lazy="selectin"
                )
        },
    ),
    ...
    mapper_registry.map_imperatively(
        ...
        properties={
            ...
            # "description": composite(lambda value: description.SkillDescription(value), diary_card_skill_assotiation.c.description),
